...
const validateRequest = (req) => {
    ...
    if (parsedURL.hostname !== req.hostname) {
        return `Please provide a url with a hostname of: ${escape(req.hostname)}  Hmmm, I guess that will restrict the submissions. TODO: Removze this restriction before the admin notices and we all get fired.`
    }
